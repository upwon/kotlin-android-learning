...
export const metadata: Metadata = {
  title: "课程地图",
  description: "Kotlin Android 学习站完整 50 章课程地图。",
};
  ...
  return (
    <main className="page-shell catalog-page">
      <header className="page-hero compact-hero">
        <div><span className="eyebrow">完整课程地图</span><h1>从 Java 到 Kotlin，<br />再到 Jetpack Compose。</h1><p>十一个部分、{allChapters.length} 章、{totalLessons} 个知识小节现已全部提供完整讲义、代码示例与动手练习。</p></div>
